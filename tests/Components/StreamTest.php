<?php
    ...
    use \WOK\HttpMessage\Components\Stream;
    ...
    class StreamTest extends TestCase {
        ...
        **/
        public function testGettingStream() {
            ...
            $this->assertEquals($this->resource, $this->stream->getStream(), 'Stream::getStream is supposed to return the resource');
        ...
        **/
        public function testGettingValuesMethods() {
            ...
            $this->assertEquals($this->value, $this->stream->getContents(), 'Stream::getContents() is supposed to return the stream value');
